...
import 'dart:ui';
import 'cohost_fridge_keeping_screen.dart';
import 'cohost_provision_list_screen.dart';

class CohostUtilitiesScreen extends StatefulWidget {
  const CohostUtilitiesScreen({super.key});

  @override
  State<CohostUtilitiesScreen> createState() => _CohostUtilitiesScreenState();
}

class _CohostUtilitiesScreenState extends State<CohostUtilitiesScreen> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const CohostFridgeKeepingScreen()),
                  );
                },
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const CohostProvisionListScreen()),
                  );
                },
