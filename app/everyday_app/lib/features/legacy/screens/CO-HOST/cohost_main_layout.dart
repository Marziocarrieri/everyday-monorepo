...
// Importiamo le 3 nuove schermate "staccate" del Co-Host
import 'cohost_utilities_screen.dart';
import 'cohost_home_screen.dart';
import 'cohost_profile_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: IndexedStack(
        ...
        children: const [
          CohostUtilitiesScreen(), // 0: Utilities
          CohostHomeScreen(),      // 1: Home
          CohostProfileScreen(),   // 2: Profilo
        ],
      ),
