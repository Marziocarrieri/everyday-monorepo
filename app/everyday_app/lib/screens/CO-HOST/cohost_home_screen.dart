...
class CohostHomeScreen extends StatefulWidget {
  ...
  @override
  State<CohostHomeScreen> createState() => _CohostHomeScreenState();
}
...
class _CohostHomeScreenState extends State<CohostHomeScreen> {
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            ...
            // Corpo scrollabile (evita overflow su schermi piccoli)
            Expanded(
              child: ListView(
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: Center(child: Text('C', style: GoogleFonts.poppins(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16))),
                            ),
    ...
    return GestureDetector(
      ...
      child: ClipRRect(
        ...
        child: BackdropFilter(
          filter: ImageFilter.blur(sigmaX: 24.0, sigmaY: 24.0),
          child: Container(
            height: 130, // Un'altezza elegante
            padding: const EdgeInsets.symmetric(horizontal: 24),
            decoration: BoxDecoration(
              gradient: LinearGradient(
                begin: Alignment.topLeft, end: Alignment.bottomRight,
                colors: [
                  const Color(0xFFF4A261).withValues(alpha: 0.2), // Stesso tono arancio della card sopra
                  Colors.white.withValues(alpha: 0.5)
                ],
              ),
              borderRadius: BorderRadius.circular(32),
            ...
            child: Stack( // Usiamo Stack per centrare perfettamente il testo come su Figma
              alignment: Alignment.center,
              children: [
                // L'icona allineata a sinistra
                Align(
                  ...
                  child: Container(
                    ...
                    // Icona "Gruppo" che riprende il concetto di famiglia
                    child: const Icon(Icons.groups_rounded, color: Color(0xFF5A8B9E), size: 30), 
                  ),
                ),
                
                // Il testo centrato perfettamente
                Text(
                  'Family', 
                  style: GoogleFonts.poppins(
                    fontSize: 22, 
  ...
  // ==========================================
  // SEZIONE 4: TASTO FLOATING (AI Assistant)
  // ==========================================
